	...
	return (
		<html lang="en">
			<body className={inter.className + " flex h-screen"}>
				<nav className="hidden sm:flex lg:w-1/6 md:w-1/3 flex-col justify-between p-10 border border-gray-300 bg-sky-500">
					<AnimatedLogo />
					<NavLinks />
				...
				<div className="fixed bottom-10 right-0  bg-white">
					<div>
						<h3>Theme</h3>
